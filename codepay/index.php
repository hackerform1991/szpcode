...
$price = trim($_GET['price']); //   http://域名/codepay/?user=admin 访问则自动填写了账户信息
    ...
    <section class="clearfix g-member">
        ...
        <form action="codepay.php" method="post">
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">充值的方式：<label
                            class="input" style="border: 1px solid #EAEAEA;height: 35px;font-size:30px;"> 
							<input type="text" placeholder="自动充值" 
									style="width: 180px;font-size:20px;" readonly  unselectable="on">
                           </label>
                    </li>				
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">您选择充值：<label
                            ...
                            <input type="text" name="price" id="price" placeholder="如：50" value="<?php echo $price ?>"
                                   style="width: 170px;color: red;font-size:20px;" readonly  unselectable="on">   <!--默认输入金额值50-->
                        </label> 元
                    </li>
                    <li class="gray6"
