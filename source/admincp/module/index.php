...
<div id="notice"><a onclick="$(\'main\').src=\'?iframe=update&setup=checkup\'">您目前使用的 万源分发平台 程序有新版本发布<span>在线升级[<b id="build" style="color:red"></b>]</span></a></div>
...
<div class="mainhd">
<a href="?iframe=index" class="logo">万源科技 Administrator\'s Control Panel</a>
...
echo IN_BUILD;
echo '</p>
	<p>Powered by <a href="/" target="_blank"> 万源分发</a></p>
	<p>&copy; 2011-';
echo date('Y');
echo ', <a href="/" target="_blank">万源科技 Inc.</a></p>
</div>
